...
import com.sunland.rocketmq.services.MqPushService;
...
public class PushWorker implements Runnable {
    ...
    private static final MqPushService PUSH_SERVICES = MqPushService.getInstance();
    ...
    public void run() {
        while (!shouldStop) {
            PUSH_SERVICES.pullFromDefaultCFAndPush();
        }
